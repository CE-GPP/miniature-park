L.Control.Weather = L.Control.extend({
  ...
  refresh: function(callback) {
    var _this = this,
      ...
      url = "http://api.openweathermap.org/data/2.5/weather?lat=:lat&lon=:lng&lang=:lang&units=metric&appid=538514057e43e4001d09e509c2d820fb";
  ...
  _updateWidget: function(weather) {
    ...
    tpl = tpl.replace(":rain", weather.main.rain);
    tpl = tpl.replace(":visibility", weather.visibility);
